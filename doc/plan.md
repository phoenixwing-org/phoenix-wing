...
- Auto Code/Auto CAD 只从 Registry 精确消费 0.4.3，Desk Tools 与 Open Issue 仍精确消费 0.4.2；各仓均不使用相邻目录 override，机器事实由 `release-matrix.json` 维护。
...
3. **[进行中：0.4.3 消费升级]** 0.4.3 完整门禁、封签、八包公开发布与干净消费均已完成；Auto Code 0.5.1 / Auto CAD 0.1.0 已完成精确 Registry 0.4.3 消费、双 VSIX 门禁、Marketplace 发布与人工审查，下一步只剩 Desk Tools 与 Open Issue 的独立升级。
