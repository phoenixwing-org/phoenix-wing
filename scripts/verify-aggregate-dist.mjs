...
const required = [
  ...
  "components/PnwTabContainer.js",
  "components/PnwTabContainer.vue.d.ts",
  ...
  "utils/pnwFloatingViewArrangement.js",
  "utils/pnwFloatingViewArrangement.d.ts",
