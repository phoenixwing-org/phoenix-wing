...
const commit: PnwGitCommitRecord = {
  ...
  author: { name: "Phoenix Wing", email: "wing@example.invalid", date: "2026-07-18T14:55:00+08:00" },
  committer: { name: "Phoenix Wing", email: "wing@example.invalid", date: "2026-07-18T14:55:00+08:00" },
